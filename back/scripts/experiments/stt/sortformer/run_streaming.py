...
m = SortformerEncLabelModel.from_pretrained("nvidia/diar_streaming_sortformer_4spk-v2", map_location="cpu")
m.eval()
...
json.dump(out, open("streaming_out.json","w"), ensure_ascii=False, indent=1)
